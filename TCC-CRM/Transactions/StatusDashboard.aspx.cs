...
{
    public partial class StatusDashboard : System.Web.UI.Page
    {
        ...
        {
            // int CustomerID = Convert.ToInt32(cmbcustomer.SelectedIndex);
            //string selectedValue = hdncusSelectedValue.Value;
            //loadpivot();
        ...
        private void BindDashboard()
        {
            ...
            //{
            //    string query = @"SELECT B.StatusName, COUNT(A.TicketID) AS JobCount
            //             FROM status B
            ...
            //    da.Fill(dt);
            //}
            //  ds = m_BLLCommon.GetStatusData( SessionMgr.DBName);
            DataTable ds = new DataTable();
            ds = m_BLLCommon.GetStatusdashboardData(SessionMgr.DBName);
            rptStatusDashboard.DataSource = ds;
            rptStatusDashboard.DataBind();
        }
        protected void Btnclear_Click(object sender, EventArgs e)
        {
            ...
            //    int CustomerID;// = Convert.ToInt32( hdncusSelectedValue.Value);
            //    if (hdncusSelectedValue.Value == "Please Select" || hdncusSelectedValue.Value == "")
            //    {
            //        CustomerID = 0;
            //    }
            //    else
            //    {
            //        CustomerID = Convert.ToInt32(hdncusSelectedValue.Value);
            //    }
            ...
            //    ds = m_BLLCommon.GetStatusData("P", StartTime, FinishTime, CustomerID, BranchID, ProductID, ModelID, BrandID, ProblemID, EngineerID, jobtypeID, SessionMgr.DBName);
            ...
            //    if (DateTime.TryParse(ASPxDateEdit1.Value.ToString(), out startDate))
            //    {
            ...
            //        return;
            //    }
            //    if (DateTime.TryParse(ASPxDateEdit2.Value.ToString(), out endDate))
            //    {
            //        FinishTime = endDate.ToString("yyyy-MM-dd");
            //    }
            //    else
            //    {
            ...
            //                  //  newRow["SequenceNo"] = expectedStatusRow["SequenceNo"].ToString();
            //                    newRow["RowValue"] = "";
            ...
            //            }
            //        }
            //    //    ds.DefaultView.Sort = "SequenceNo ASC"; // Adjust ASC/DESC as needed
