<%@ Page Title="" Language="C#" MasterPageFile="~/MasterTemplate/TCC-CRM.Master" AutoEventWireup="true" CodeBehind="TimeandCostAnalysis.aspx.cs" Inherits="TCC_CRM.Transactions.TimeandCostAnalysis" %>
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="m-b-0 text-white">Time & Cost Analysis</h4>
                </div>
                <div class="card-body" style="padding: 22px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <dx:ASPxDateEdit ID="orderfromdt" runat="server" Theme="Glass" DateRangeSettings-CalendarColumnCount="8"
                        ...
                        <div class="col-md-2">
                            ...
                            <dx:ASPxDateEdit ID="ordertodt" Font-Names="Poppins" Font-Size="13px" runat="server" Theme="Glass" DisplayFormatString="dd-MM-yyyy" EditFormatString="dd-MM-yyyy"></dx:ASPxDateEdit>
                        </div>

                         <div class="col-md-2">
                            <label for="lblorderfromdt" class="Themefontstyles">Report Type</label>
                            <asp:DropDownList ID="cmbreporttype" runat="server" TabIndex="3" Class="select2 form-control"  >
                              ...
                              <asp:ListItem Text="Product" Value="1"></asp:ListItem>
                               ...
                               <asp:ListItem Text="Nature of Problem" Value="4"></asp:ListItem>
                               <asp:ListItem Text="Brand" Value="5"></asp:ListItem>
                                 <asp:ListItem Text="Model" Value="6"></asp:ListItem>
                                 <asp:ListItem Text="Assigned To" Value="7"></asp:ListItem>
                                 <asp:ListItem Text="Service Type" Value="9"></asp:ListItem>
                                            </asp:DropDownList>  
                        ...
                        <div class="col-md-2">
                            ...
                            <asp:Button ID="btngo" runat="server" Text="Apply" EnableTheming="True" CssClass="btn btn-outline-success btn-rounded"
                                ToolTip="Go" Style="color: white; width: 150px;" OnClick="btn_go_click"></asp:Button>
                        </div>
                        ...
                        <div class="col-md-1.5">
                            ...
                            <asp:Button ID="excelxport" runat="server" Text="Download Excel" EnableTheming="True" CssClass="btn btn-outline-success btn-rounded"
                                ToolTip="Add New" Style="color: white; width: 150px;" OnClick="excelexport_Click" />
                    ...
                    <div class="table-responsive m-t-1 p-t-10">
                        <dx:ASPxGridView ID="ASPxGridView1" runat="server" Width="100%" Theme="DevEx" EnableRowsCache="False" KeyFieldName="TicketID" Font-Names="Poppins" Font-Size="13px">
                            ...
                            <Columns>
                                <dx:GridViewDataTextColumn FieldName="TicketNo" VisibleIndex="0" Caption="Print" Width="10px" CellStyle-HorizontalAlign="Center">
                                    <DataItemTemplate>
                                ...
                                <dx:GridViewDataTextColumn FieldName="TicketID" VisibleIndex="1" Caption="Job No" CellStyle-HorizontalAlign="Center" Width="50px">
                                    <DataItemTemplate>
