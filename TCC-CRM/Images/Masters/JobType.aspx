<%@ Page Title="" Language="C#" MasterPageFile="~/MasterTemplate/TCC-CRM.Master" AutoEventWireup="true" CodeBehind="JobType.aspx.cs" Inherits="TCC_CRM.Masters.JobType" %>
    ...
    <div class="row" style="width: 100%">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title " id="Heading">Edit JobType</h4>
                    </div>

                    <div class="modal-body">
                        <asp:Label ID="lbljobtypeid" runat="server" Style="visibility: hidden" Text=""></asp:Label>
                       <%--  <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <asp:Label ID="lblcode" runat="server" Text="JobType Code"></asp:Label>
                        ...
                        <div class="form-group">
                            <asp:Label ID="lblname" runat="server" Text="JobType Name"></asp:Label>
                        ...
                        <asp:Label ID="lblval" runat="server" Text="JobType Code" ForeColor="Red" Font-Bold="true" Visible="false"></asp:Label>
                    </div>
        ...
        <div class="col-12">
            <div class="card-header" style="margin-top:-18px";>
                <h4 class="m-b-0 text-white">JobType List</h4>
            </div>
            ...
            <div class="card">
                ...
                TabIndex="28" Style="float: right; position: relative; margin-top: 3px; margin-right: 10px;" OnClientClick="openModal();" />
                    <div class="table-responsive m-t-1">
                        <asp:GridView ID="gvJobType" runat="server"  OnPreRender="GridView_PreRender" CssClass="display nowrap table"
                            DataKeyNames="JobTypeid" OnRowDataBound="GridView_RowDataBound">
                            <Columns>
                                <asp:TemplateField HeaderText="JobType_id" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblJobTypeid" runat="server" Text='<%# Eval("JobTypeid") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
