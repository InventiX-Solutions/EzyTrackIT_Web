<%@ Page Title="" Language="C#" MasterPageFile="~/MasterTemplate/TCC-CRM.Master" AutoEventWireup="true" CodeBehind="ServiceTypeList.aspx.cs" Inherits="TCC_CRM.Masters.ServiceTypeList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 ...
 { swal({ title: test, type: 'success' }); }
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#<%= gvstypelist.ClientID %>').DataTable(
                                {
                                    dom: 'Bfrtip',
                                    ...
                                    buttons: [
                                      {
                                          ...
                                          title: function () {
                                              ...
                                              return 'ServiceTypeList_' + dateString;
                                          }
                                      },
                                        {
                                            text: 'New',
                                            action: function (e, dt, node, config) {
                                                ...
                                                $('#<%= txtscode.ClientID %>').val('');
                                                $('#<%= txtsname.ClientID %>').val('');
                                                $('#<%= lblstypeid.ClientID %>').text('');
                                                $('#Heading').text('New Service Type');
                                                openModal();
                                            }
                                        }
                                    ]
 ...
 <div class="row" style="width:100%">
    ...
    <div class="modal-content">
        ...
        <h4 class="modal-title " id="Heading">Edit Service Type</h4>
      </div>
        
        <div class="modal-body">
             <asp:Label ID="lblstypeid" runat="server" style="visibility:hidden" Text=""></asp:Label>
          <div class="form-group">
              
              <asp:Label ID="lblcode" runat="server" Text="Service Type Code"></asp:Label>
      ...
      <div class="form-group">
              <asp:Label ID="lblname" runat="server" Text="Service Type Name"></asp:Label>
            ...
            <asp:Label ID="lblval" runat="server" Text="Service Type Code" ForeColor="Red" Font-Bold="true" Visible="false"></asp:Label>
      </div>
    ...
    <!-- /.modal-content --> 
     ...
     <div class="col-12">
           <div class="card-header" style="margin-top:-18px";>
            <h4 class="m-b-0 text-white">Service Type List</h4>
        </div>
        <div class="card">
            <div class="card-body">
                ...
                <asp:GridView ID="gvstypelist" runat="server" AutoGenerateColumns="true" OnPreRender="GridView_PreRender" CssClass="display nowrap table"
                     DataKeyNames="service_typeid" OnRowDataBound="GridView_RowDataBound">
                      <Columns>
                        <asp:TemplateField HeaderText="brand_id" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblservice_typeid" runat="server" Text='<%# Eval("service_typeid") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
