<%@ Page Title="" Language="C#" MasterPageFile="~/MasterTemplate/TCC-CRM.Master" AutoEventWireup="true" CodeBehind="severity.aspx.cs" Inherits="TCC_CRM.Masters.severity" %>
 ...
 { swal({ title: test, type: 'success' }); }
      ...
      <script type="text/javascript">
          $(document).ready(function () {
              ...
              $('#<%= gvSeveritylist.ClientID %>').DataTable(
                                    {
                                        dom: 'Bfrtip',
                                        ...
                                        buttons: [
                                          {
                                          ...
                                          },
                                            {
                                                ...
                                                $('#<%= lblSevid.ClientID %>').text('');
                                                    $('#Heading').text('New Severity');
                                                openModal();
                                            }
                                        }
                                    ]
    ...
    <div class="modal-content">
        ...
        <h4 class="modal-title " id="Heading">Edit Severity</h4>
      </div>
        
        <div class="modal-body">
             <asp:Label ID="lblSevid" runat="server" style="visibility:hidden" Text=""></asp:Label>
      ...
      <div class="form-group">
            ...
            <asp:Label ID="lblval" runat="server" Text="Severity Code" ForeColor="Red" Font-Bold="true" Visible="false"></asp:Label>
      </div>
    ...
    <!-- /.modal-content --> 
     ...
     <div class="col-12">
           <div class="card-header" style="margin-top:-18px";>
            <h4 class="m-b-0 text-white">Severity List</h4>
        </div>
        <div class="card">
            <div class="card-body">
                ...
                <asp:GridView ID="gvSeveritylist" runat="server" AutoGenerateColumns="true"  OnPreRender="GridView_PreRender" CssClass="display nowrap table"
                     DataKeyNames="sevID" OnRowDataBound="GridView_RowDataBound">
                      <Columns>
                        <asp:TemplateField HeaderText="sevID" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblsev_id" runat="server" Text='<%# Eval("sevID") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
