<%@ Page Title="" Language="C#" MasterPageFile="~/MasterTemplate/TCC-CRM.Master" AutoEventWireup="true" CodeBehind="CustomerList.aspx.cs" Inherits="TCC_CRM.Masters.CustomerList" %>
 ...
 { swal({ title: test, type: 'success' }); }
                                    ...
                                    buttons: [
                                      {
                                          ...
                                          title: function () {
                                              ...
                                              return 'LocationList_' + dateString;
                                          }
                                      },
                                        {
                                            text: 'New',
                                            action: function (e, dt, node, config) {
                                                //var url = "NewLocation.aspx?Location_ID=0&field2=New";
    ...
    <div class="row" style="width: 100%">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title " id="Heading">Edit Customer</h4>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <asp:Label ID="lblcode" runat="server" Text="Customer Code"></asp:Label>
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <asp:TextBox ID="txtbemailid" runat="server" TabIndex="4" MaxLength="100" CssClass="form-control" placeholder="Enter Email Id" required="required">
                            </asp:TextBox>
                        </div>
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <asp:Button ID="btn_import" runat="server" Text="Import" OnClick="btn_import_Click"  formnovalidate CssClass="btn btn-success" ToolTip="Import"  />
                    <asp:Button ID="btnexcelImportemp" runat="server" Text="Download Excel Import Template" OnClick="btnexcelImportemp_Click"   formnovalidate CssClass="btn btn-success" ToolTip="Import"  />
                ...
                TabIndex="28" Style="float: right; position: relative; margin-top: 3px; margin-right: 10px;" OnClientClick="openModal();" />
                    <div class="table-responsive m-t-1">
                        <asp:GridView ID="gvCustomerlist" runat="server" AutoGenerateColumns="true" OnPreRender="GridView_PreRender" CssClass="display nowrap table"
                            DataKeyNames="customer_ID" OnRowDataBound="GridView_RowDataBound">
                            <Columns>
