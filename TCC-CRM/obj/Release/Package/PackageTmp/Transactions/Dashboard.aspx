<%@ Page Title="" Language="C#" MasterPageFile="~/MasterTemplate/TCC-CRM.Master" AutoEventWireup="true"  EnableEventValidation="false"  EnableViewState="true" CodeBehind="Dashboard.aspx.cs" Inherits="TCC_CRM.Transactions.Dashboard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        function myFunction() {
            ...
            $("#<%=hdncusSelectedValue.ClientID %>").val(selectedValue);
