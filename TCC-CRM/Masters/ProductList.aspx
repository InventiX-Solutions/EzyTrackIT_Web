<%@ Page Title="" Language="C#" MasterPageFile="~/MasterTemplate/TCC-CRM.Master" AutoEventWireup="true" CodeBehind="ProductList.aspx.cs" Inherits="TCC_CRM.Masters.ProductList" %>
     ...
     <script type="text/javascript">
      ...
      <script type="text/javascript">
          $(document).ready(function () {
            ...
            $('#<%= gvProductlist.ClientID %>').DataTable(
                                {
                                    dom: 'Bfrtip',
                                    ...
                                    buttons: [
                                      {
                                          ...
                                          title: function () {
                                              ...
                                              return 'ProductList_' + dateString;
                                          }
                                      },
                                        {
                                            text: 'New',
    ...
    <div class="row" style="width:100%">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title " id="Heading">Edit Product</h4>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <asp:Label ID="lblval" runat="server" Text="Product Code" ForeColor="Red" Font-Bold="true" Visible="false"></asp:Label>
                    </div>
     ...
     <div class="col-12">
           <div class="card-header" style="margin-top:-18px";>
            <h4 class="m-b-0 text-white">Product List</h4>
        </div>
        <div class="card">
            <div class="card-body">
                <asp:Button ID="btnnew" runat="server" Text="&#43; Add New" CssClass="btn btn-success" ToolTip="Add New" Width="100px"
                ...
                <asp:GridView ID="gvProductlist" runat="server" AutoGenerateColumns="true"  OnPreRender="GridView_PreRender" CssClass="display nowrap table"
                     DataKeyNames="product_id" OnRowDataBound="GridView_RowDataBound">
                      <Columns>
                        <asp:TemplateField HeaderText="product_id" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblproduct_id" Visible="false" runat="server"  Text='<%# Eval("product_id")  %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
