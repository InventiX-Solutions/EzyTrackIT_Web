<%@ Page Title="" Language="C#" MasterPageFile="~/MasterTemplate/TCC-CRM.Master" AutoEventWireup="true" CodeBehind="VehicleList.aspx.cs" Inherits="TCC_CRM.Masters.VehicleList" %>
 ...
 { swal({ title: test, type: 'success' }); }
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#<%= gvVehiclelist.ClientID %>').DataTable(
                                {
                                    dom: 'Bfrtip',
                                    ...
                                    buttons: [
                                      {
                                          ...
                                          title: function () {
                                              ...
                                              return 'VehicleList_' + dateString;
                                          }
                                      },
                                        {
                                            text: 'New',
                                            action: function (e, dt, node, config) {
                                                ...
                                                $('#<%= lblVehicleid.ClientID %>').text('');
                                                $('#Heading').text('New Vehicle');
                                                openModal();
                                            }
                                        }
                                    ]
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title " id="Heading">Edit Vehicle</h4>
                    </div>

                    <div class="modal-body">
                        <asp:Label ID="lblVehicleid" runat="server" Style="visibility: hidden" Text=""></asp:Label>
                        <div class="form-group">

                            <asp:Label ID="lblcode" runat="server" Text="Vehicle Code"></asp:Label>
                        ...
                        <div class="form-group">
                            <asp:Label ID="lblname" runat="server" Text="Vehicle Name"></asp:Label>
                         ...
                         <div class="form-group">
                            ...
                            <asp:TextBox ID="txtvehicleno" runat="server" TabIndex="5" MaxLength="100" CssClass="form-control"  >
                            </asp:TextBox>
                        </div>
                         <div class="form-group">
                            <asp:Label ID="lblremarks" runat="server" Text="Remarks"></asp:Label>
                            <asp:TextBox ID="txtremarks" runat="server" TabIndex="6" MaxLength="200" CssClass="form-control">
                            </asp:TextBox>
                        </div>
                        <asp:Label ID="lblval" runat="server" Text="Vehicle Code" ForeColor="Red" Font-Bold="true" Visible="false"></asp:Label>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive m-t-1">
                        <asp:GridView ID="gvVehiclelist" runat="server" AutoGenerateColumns="true" OnPreRender="GridView_PreRender" CssClass="display nowrap table"
                            DataKeyNames="VehicleID" OnRowDataBound="GridView_RowDataBound">
                            <Columns>
                                <asp:TemplateField HeaderText="VehicleID" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblVehicle_ID" runat="server" Text='<%# Eval("VehicleID") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
