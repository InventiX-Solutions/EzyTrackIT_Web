...
{
    public partial class ImportCustomerBranch : System.Web.UI.Page
    {
        ...
        public string UploadPath1 = "/UploadDocuments/CustomerBranchImport/";
                ...
                if (FileUploader.PostedFile != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(FileUploader.PostedFile.FileName.ToString()))
                    {
                        ...
                        if (!string.IsNullOrEmpty(Excelfilepath))
                        {
                            ...
                            compileddata = bll.getcompileddata(dtgrn, SessionMgr.DBName);
